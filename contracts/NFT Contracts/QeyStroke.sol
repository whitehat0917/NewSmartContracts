...
contract QeyStroke is ERC1155Burnable, Ownable, ReentrancyGuard, Pausable, PaymentSplitter {
    ...
    /**
        @dev burning a single parcel 4 will mint a genesis with id 3784 (+1 from supply)
    ...
    /**
        @dev burn 3 parcels of type 1,2 and 3 to mint a genesis with id 3784 (+1 from supply)
